...
rkf = RepeatedKFold(n_splits=folds, n_repeats=1, random_state=1)
...
for tr_i, tst_i in rkf.split(SAMP_IDX):
	...
	latEstFold = magicLAT(coordinateMatrix, connectivityMatrix, TrIdx, TrCoord, TrVal, SPARSIFY_THRESHOLD)

	yhatFold = latEstFold[TstIdx]
